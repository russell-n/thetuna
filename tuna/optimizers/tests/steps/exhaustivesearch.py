...
from hamcrest import assert_that, equal_to, is_, instance_of, raises
...
def invalid_configuration(context):
    ...
    context.invalid_minima = ExhaustiveSearch(minima=maxima,
                                              ...
                                              quality=quality,
                                              solutions=storage)
    context.invalid_minima_dimension = ExhaustiveSearch(minima=one_dimension,
                                                        maxima=maxima,
                                                        increments=increments,
                                                        quality=quality,
                                                        solutions=storage)
...
def raise_error(context):
    ...
    assert_that(context.invalid_increments_dimension.check_rep, raises(ConfigurationError))
