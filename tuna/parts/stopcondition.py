...
class StopCondition(object):
    ...
    def __init__(self, time_limit, end_time=None):
        ...
        :param:
         ...
         - `time_limit`: max seconds from first call to stop (timedelta object)
        """
    ...
    def time_limit(self):
        """
        The max time to allow (datetime.timedelta)
        """
...
class StopConditionGenerator(object):
    ...
    def __init__(self, time_limit, maximum_time, minimum_time=1, 
                 end_time=None, ideal=None, delta=0,
                 use_singleton=True, random_function=random.uniform):
        """
    ...
    def end_time(self):
        """
        The datetime to stop all stop-conditions (time-limit + now)
        """
        if self._end_time is None:
