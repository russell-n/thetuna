...
This is a plugin for :ref:`The Big Sleep <tuna-big-sleep>`, code that does nothing but countdown. I guess it could be called count-down... Anyway.
...
.. currentmodule:: tuna.plugins.sleep_plugin
.. autosummary::
   :toctree: api
