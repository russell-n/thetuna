...
from tuna import TUNASECTION, MODULES_SECTION
...
class Tuna(BasePlugin):
    ...
    def product(self):
        ...
        for config_file in self.configfiles:
            ...
            names = (name for name in configuration.options(TUNASECTION) if not
                     (name in defaults and
                      defaults[name] ==
                      configuration.get(TUNASECTION, name)))
            ...
            for operation_name in names:
                ...
                for plugin_section_name in configuration.get_list(TUNASECTION, operation_name):                    
